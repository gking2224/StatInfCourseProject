...
It should be noted that the ten subjects are not identified in the dataset. This means that the data cannot be paired.
...
<<ci2>>
```
Assumes sample subjects are representative of the population.
